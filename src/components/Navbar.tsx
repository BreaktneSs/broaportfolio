      ...
      >
        ...
        >
          <button
            ...
            className="font-display flex items-center gap-2 text-base font-bold tracking-tight text-[rgb(var(--text-strong))] transition-colors hover:text-[rgb(var(--glow-a))]"
          >
